...
export function buildAgentBehaviorPromptQuick(): string {
  return [
    ...
    '- Keep going until the user\'s request is fully resolved. Only end your turn when you are sure the problem is solved (or blocked on a real question). Do not stop after a plan-only reply, a partial fix, or "I would next…".',
