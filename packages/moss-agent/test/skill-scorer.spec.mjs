 ...
 *   node packages/moss-skills/test/skill-scorer.spec.mjs
 */

import assert from 'node:assert/strict';
import { scoreSkillCandidate, isHighConfidence, isMediumConfidence } from '../dist/skill-learning/skill-scorer.js';
