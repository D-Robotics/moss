 ...
 *   node packages/moss-agent/test/moss-agent-output-guardrail.spec.mjs
 */
...
console.log('[PASS] MossAgent output guardrail gates visible assistant text before streaming and persistence');
