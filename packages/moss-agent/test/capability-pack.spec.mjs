 ...
 * in MossAgent: a mounted pack must (1) register its tools, (2) inject its
 ...
 *   node packages/moss-agent/test/capability-pack.spec.mjs
 */
...
// tools/prompt/requirements — but MossAgent requires a valid LLMProvider.
