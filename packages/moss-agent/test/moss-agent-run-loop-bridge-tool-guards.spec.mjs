#!/usr/bin/env node
/**
 * Parity tests for MossAgent.streamChat -> runAgentLoop bridge:
 * tool loop guard, idempotent replay, and redundant web_fetch suppression.
 *
 * Run:
 *   npm run build -w @rdk-moss/agent
 *   node packages/moss-agent/test/moss-agent-run-loop-bridge-tool-guards.spec.mjs
 */
...
await withEnv({ MOSS_TOOL_LOOP_IDENTICAL_LIMIT: '2' }, async () => {
...
console.log('[PASS] MossAgent bridge tool guard/replay/suppression parity tests');
