#!/usr/bin/env node
/**
 * @rdk-moss/agent/memory — knowledge-card distillation unit tests
 *
 * Run after package build:
 *   npm run build -w @rdk-moss/agent/memory && node packages/moss-memory/test/knowledge-card.spec.mjs
 */
