 ...
 *   node packages/moss-agent/test/moss-agent-run-loop-bridge-cancel-safety.spec.mjs
 */
...
console.log('[PASS] MossAgent runAgentLoop bridge handles cancel and safety blocking');
