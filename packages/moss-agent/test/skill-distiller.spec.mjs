 ...
 *   node packages/moss-skills/test/skill-distiller.spec.mjs
 */
...
import { writeSkillCandidate, getCandidatesRoot } from '../dist/skill-learning/skill-candidate-store.js';
import { distillCandidate } from '../dist/skill-learning/skill-distiller.js';

const tmpDir = await fs.mkdtemp(path.join(os.tmpdir(), 'moss-distiller-'));
