 ...
 *   node packages/moss-agent/test/cli-board-detection.spec.mjs
 */
...
const BOARD_ENV = ['MOSS_BOARD_RUNTIME', 'MOSS_HYBRID_MODE', 'RDK_BOARD', 'RDK_MODEL', 'TROS_DISTRO'];
...
withoutEnv(BOARD_ENV, () => {
  ...
  console.log('  [PASS] MOSS_BOARD_RUNTIME=1 still forces on-board');
});
