 ...
 *   node packages/moss-skills/test/detect-skill-learning-intent.spec.mjs
 */

import assert from 'node:assert/strict';
import { detectSkillLearningIntent } from '../dist/skill-learning/conversation-skill-learner.js';
