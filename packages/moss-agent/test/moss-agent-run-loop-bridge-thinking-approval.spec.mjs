 ...
 *   node packages/moss-agent/test/moss-agent-run-loop-bridge-thinking-approval.spec.mjs
 */
...
console.log('[PASS] MossAgent runAgentLoop bridge routes thinking and denied approvals');
