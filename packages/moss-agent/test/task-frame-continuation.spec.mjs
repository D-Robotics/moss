 ...
 *   node packages/moss-agent/test/task-frame-continuation.spec.mjs
 */
...
assert.match(serialized, /moss_working_context_checkpoint/);
...
assert.match(resumeRequest.systemPrompt, /<moss_working_context>/);
