...
for (const action of ['inspect','render','replace-text','audit']) assert.ok(body.includes(`'${action}'`), `supports ${action}`);
assert.match(body,/PowerPoint\.Application/); assert.match(body,/SlideWidth/); assert.match(body,/SaveAs/);
