 ...
 *   node packages/moss-agent/test/moss-agent-input-guardrail.spec.mjs
 */
...
console.log('[PASS] MossAgent input guardrail gates and normalizes user messages before persistence');
