 ...
 *
 * - Each MossAgent owns an isolated PlatformExtensionRegistry.
 * - Deprecated free-function wrappers still target a process-scoped singleton.
 * - Legacy wrapper knowledge is bridged into future MossAgent instances.
 *
 * Run:
 *   npm run build -w @rdk-moss/agent
 *   node packages/moss-agent/test/extensions-singleton.spec.mjs
 */
