...

{
  ...
  assert.ok(
    !help.includes('Very long extension description 79'),
    'overview does not dump every extension description'
  );
...

{
  ...
  assert.ok(
    rows.some(([cmd]) => cmd === '/soul'),
    'typing "/sou" surfaces the Soul command'
  );
}
