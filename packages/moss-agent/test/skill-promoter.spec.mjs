 ...
 *   node packages/moss-skills/test/skill-promoter.spec.mjs
 */
...
import {
  writeSkillCandidate,
  getCandidatesRoot,
} from '../dist/skill-learning/skill-candidate-store.js';
import { promoteSkillCandidate } from '../dist/skill-learning/skill-promoter.js';
import { MOSS_SKILL_META_FILE } from '../dist/skill-learning/skill-metadata.js';

const tmpDir = await fs.mkdtemp(path.join(os.tmpdir(), 'moss-promoter-'));
