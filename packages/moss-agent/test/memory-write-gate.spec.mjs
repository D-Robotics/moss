#!/usr/bin/env node
/**
 * @rdk-moss/agent/memory — validateMemoryWriteContent 价值/安全门槛单测
 *
 ...
 *   npm run build -w @rdk-moss/agent/memory && node packages/moss-memory/test/memory-write-gate.spec.mjs
 */
