#!/usr/bin/env node
/**
 * @rdk-moss/agent/memory — self-learning-memory draft generation unit tests
 *
 * Run after package build:
 *   npm run build -w @rdk-moss/agent/memory && node packages/moss-memory/test/self-learning-memory.spec.mjs
 */
