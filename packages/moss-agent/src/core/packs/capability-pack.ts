 ...
 * onto a MossAgent at construction time.
 *
 ...
 * runtime reader lives in `MossAgent`: when `capabilityPacks` is set, the
...
export interface CapabilityPack {
   ...
   * `MossAgent.getCapabilityPackRequirements()` and cross-check them against
 ...
 * runtime application happens in `MossAgent`.
 *
